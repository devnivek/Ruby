...
describe ElementSwap do
  it '1: Troca posição de elementos' do
    letters = ['A', 'C']
  ...
  it '2: Troca posição de elementos' do
    letters = ['K', 'V', 'H', 'C']
    instructions = <<~INSTRUCTIONS
    2<>3
    INSTRUCTIONS
  ...
  it '3: Troca posição de elementos' do
    letters = ['Y', 'Q', 'S', 'R', 'O']
    instructions = <<~INSTRUCTIONS
    1<>4
    INSTRUCTIONS
  ...
  it '4: Troca posição de elementos' do
    letters = ['C', 'K', 'M', 'E', 'V', 'G']
    instructions = <<~INSTRUCTIONS
    2<>3
    4<>0
  ...
  it '5: Troca posição de elementos' do
  ...
  it '6: Troca posição de elementos' do
